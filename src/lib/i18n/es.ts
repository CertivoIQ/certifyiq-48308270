...
export const es: Dictionary = {
  ...
  "welcome.hero.title": "Encuentre problemas de cumplimiento antes que el auditor.",
  "welcome.hero.subtitle":
    "CertivoIQ utiliza IA para extraer evidencia de archivos de certificación de vivienda asequible, aplica reglas de cumplimiento versionadas de forma determinista y muestra exactamente por qué se generó cada hallazgo.",
  "welcome.hero.cta": "Revise 3 archivos gratis",

...
export const es: Dictionary = {
  ...
  "shell.trial.upgrade": "Pruebe CertivoIQ gratis",
  ...
  "welcome.close.body": "Comience con tres revisiones gratuitas de certificación usando el correo electrónico del sitio web de su organización.",

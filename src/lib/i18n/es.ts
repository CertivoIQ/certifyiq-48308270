...
export const es: Dictionary = {
  ...
  "nav.trial": "Mis revisiones de certificación gratuitas",
  ...
  "shell.trial.status": "Revisiones de certificación gratuitas · {used}/{allowed} revisiones usadas",
  "shell.trial.watchDemo": "Ver la demostración",
  "shell.trial.upgrade": "Elegir un plan",
  ...
  "welcome.pill": "{allowed} revisiones de certificación gratis",
  "welcome.hero.title": "Encuentre problemas de cumplimiento antes que el auditor.",
  "welcome.hero.subtitle": "CertivoIQ utiliza IA para extraer evidencia de archivos de certificación de vivienda asequible, aplica reglas de cumplimiento versionadas de forma determinista y muestra exactamente por qué se generó cada hallazgo.",
  ...
  "welcome.cta.trial": "Ejecute 3 revisiones de certificación gratis",
  ...
  "welcome.video.trialCta": "Ejecute 3 revisiones de certificación gratis",
  "welcome.risks.title": "Lo que una revisión manual pasa por alto — y lo que cuesta",
  "welcome.risks.body": "Cada punto a continuación es una causa real de multas, acuerdos de reembolso, hallazgos en el IRS Form 8823 o recaptura de créditos fiscales. La revisión manual detecta la mayoría, casi siempre. CertivoIQ los verifica todos, siempre.",
  "welcome.value.title": "Compare CertivoIQ con su costo actual de cumplimiento",
  "welcome.value.body": "Ingrese sus propias cifras a continuación. CertivoIQ no estima sus ahorros ni garantiza evitar hallazgos, multas o recaptura de créditos — comience con 3 revisiones de certificación gratis.",
  "welcome.why.1.title": "Sus créditos fiscales quedan intactos",
  "welcome.why.1.body": "Un solo hallazgo §42 sin corregir puede provocar un IRS Form 8823 y poner en riesgo los créditos asignados. CertivoIQ lo detecta cuando aún se puede subsanar.",
  "welcome.why.2.title": "Menos hallazgos en auditoría",
  "welcome.why.2.body": "Cada certificación recibe un resultado de Aprobado o No aprobado según el paquete de reglas exacto asignado a esa propiedad, con los pasos de corrección redactados.",
  "welcome.why.3.title": "Minutos, no horas",
  "welcome.why.3.body": "Las revisiones bajan de unos 41 minutos de trabajo manual a cerca de 4 minutos, y una persona conserva la autoridad de aprobación final.",
  "welcome.close.title": "Use sus 3 revisiones de certificación gratis",
  "welcome.close.body": "Ejecute tres archivos reales de certificación con CertivoIQ, inspeccione el rastro de evidencia y decida si la plataforma pertenece a su flujo de cumplimiento.",
  "welcome.close.cta": "Ejecutar revisiones gratis",

...
export function isTicContent(text) {
  ...
  const supplemental = (/annual income calculation worksheet/i.test(normalized) && /asset calculations/i.test(normalized))
    ...
    || (/signature.*head of household/i.test(normalized) && /adult household member/i.test(normalized) && /ethnicity/i.test(normalized));

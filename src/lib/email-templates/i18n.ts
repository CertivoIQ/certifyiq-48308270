...
const en = {
  ...
  'intro.addons': 'Multifamily Enterprise is $65,000 per selected state annually.',
...
const es: Record<EmailKey, string> = {
  ...
  'intro.addons': 'Multifamily Enterprise cuesta $65,000 por estado seleccionado al año.',

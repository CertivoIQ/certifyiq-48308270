...
const en = {
  ...
  'intro.preview': 'Protect {company} tax credits — automated compliance review for LIHTC, HOME, Section 8 & HOTMA',
  ...
  'intro.body': 'CertivoIQ is a compliance intelligence platform built for affordable housing teams{company}. Every tenant income certification is reviewed against the exact rule pack assigned to that property — LIHTC §42, HOME, Section 8/PBS8, HOTMA, Rural Development and Tax-Exempt Bond — and returned with a Pass or Fail score, cited findings and written correction steps before an auditor ever sees the file.',
  'intro.body.company': ' like {company}',
  'intro.section.what': 'WHAT THE PLATFORM DOES',
  'intro.stat.time': 'Average review time per certification',
  ...
  'intro.bar.ai': 'CertivoIQ certification review',
  ...
  'intro.benefit.2': 'Standardized reviews — the same rule logic applied by every reviewer, in every state.',
  ...
  'intro.benefit.5': 'Merlin, the compliance assistant, cites the governing rule the moment a reviewer gets stuck.',
  'intro.section.pricing': 'PLANS & PRICING',
  'intro.plan.price': '{price}/month',
  'intro.addons': 'Add-ons: additional state rule packs $99–$199/state/month · CertivoIQ Academy $49/user/month or $499/property/month · API access $500–$2,000/month · Document processing beyond plan allowance $3 per uploaded certification.',
  ...
  'intro.startFree.detail': '— 3 full certification reviews, no card required.',
...
const es: Record<EmailKey, string> = {
  ...
  'intro.bar.ai': 'Revisión de certificación de CertivoIQ',
  ...
  'intro.benefit.2': 'Revisiones estandarizadas: la misma lógica normativa aplicada por cada revisor, en cada estado.',
  ...
  'intro.benefit.5': 'Merlin, el asistente de cumplimiento con IA, cita la norma aplicable en el momento en que un revisor se detiene.',
  ...
  'intro.startFree.detail': '— 3 revisiones completas de certificación con IA, sin tarjeta.',

...
const en = {
  ...
  'intro.body': 'CertivoIQ is an AI compliance platform built for affordable housing teams{company}. Every tenant income certification is reviewed against the exact rule pack assigned to that property — LIHTC §42, HOME, Section 8/PBS8, HOTMA, Rural Development and Tax-Exempt Bond — and returned with a Pass or Fail score, cited findings and written correction steps before an auditor ever sees the file.',
  ...
  'intro.benefit.5': 'Merlin, the AI compliance assistant, cites the governing rule the moment a reviewer gets stuck.',
  ...
  'intro.startFree.detail': '— 3 full AI certification reviews, no card required.',

...
function ComplianceIntelligenceWorkspace() {
  return <><ComplianceIntelligenceSuite /><div className="mx-auto w-full max-w-7xl px-6 pb-10 md:px-10"><ComplianceTimeMachine /><ComplianceImpactAnalysis /><RegulatoryDiffEngine /></div></>;
}

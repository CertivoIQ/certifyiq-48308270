...
const BENEFITS = [
  ...
  "Traceable evidence, rule versions and human sign-off in one defensible review record.",
  "Compliance intelligence that surfaces recurring findings and operational risk before an audit.",
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="no-print border-b border-border">
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-between gap-3 px-5 py-4">
          <div><h1 className="font-display text-[18px]">Marketing kit — intro leave-behind</h1><p className="text-[12.5px] text-muted-foreground">Print or save as PDF for prospect meetings.</p></div>
      ...
      <article className="print-sheet mx-auto my-8 max-w-3xl rounded-lg border border-border bg-card p-8 shadow-ledger print:my-0">
        <header className="flex items-start justify-between gap-4 border-b border-border pb-5">
          <div><p className="font-display text-[24px] leading-none">Certivo<span className="text-gold">IQ</span></p><p className="mt-1.5 text-[12.5px] text-muted-foreground">Affordable housing compliance platform — LIHTC · HOME · Section 8 · HOTMA · RD · Bond</p></div>
          <p className="text-right text-[11.5px] leading-snug text-muted-foreground">certivoiq.com/welcome<br />Compliance intelligence for all 50 states</p>
        </header>
        <section className="print-avoid-break mt-6"><h2 className="font-display text-[26px] leading-[1.15]">One missed certification can cost <span className="text-reject">years of tax credits</span></h2><p className="mt-3 text-[13.5px] leading-relaxed text-muted-foreground">CertivoIQ reviews tenant income certifications against the rule pack assigned to the property and returns traceable findings and correction steps before an auditor sees the file. A human reviewer retains final sign-off authority.</p></section>
        ...
        <section className="print-avoid-break mt-6"><h3 className="cite font-mono">ANNUAL PLATFORM PRICING</h3><div className="mt-3 rounded-lg border border-primary/25 bg-accent p-4"><p className="font-display text-[24px]">$65,000/year</p><p className="mt-1 text-[12.5px] text-muted-foreground">One platform subscription. All generally available CertivoIQ features included. No feature tiers.</p></div></section>

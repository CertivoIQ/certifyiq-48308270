    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="print-sheet mx-auto my-8 max-w-3xl rounded-lg border border-border bg-card p-8 shadow-ledger print:my-0">
        <header className="flex items-start justify-between gap-4 border-b border-border pb-5">
          <div><img src="/certivoiq-logo.png" alt="CertivoIQ" className="h-14 w-auto object-contain" /><p className="mt-1.5 text-[12.5px] text-muted-foreground">Compliance intelligence infrastructure — LIHTC · HOME · Project-Based Section 8 · HOTMA</p></div>

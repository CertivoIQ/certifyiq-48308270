    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <footer className="border-t border-border py-8">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-5 text-center sm:flex-row sm:text-left lg:px-8">
          <div><img src="/certivoiq-logo.png" alt="CertivoIQ" className="h-9 w-auto object-contain" /><p className="mt-1 text-[11px] text-muted-foreground">FIND COMPLIANCE RISK BEFORE THE AUDITOR.</p></div>

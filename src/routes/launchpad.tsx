...
export const Route = createFileRoute("/launchpad")({
  head: () => ({
    meta: [
      { title: "CertifyIQ LaunchPad — Guided Setup to Audit-Ready" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "CertifyIQ LaunchPad — Your guided path from signup to audit-ready" },
      {
        property: "og:description",
        content: "Ten steps, 20–30 minutes, ending in CertifyIQ Launch Certified.",
      },
        ...
        <div className="min-w-0 space-y-4">
          <Panel bodyClassName="p-6">
            ...
            <h2 className="mt-3 font-display text-[26px] leading-tight">
              {done ? <span className="brand-text">You are officially live on CertifyIQ</span> : current.title}
            </h2>
            <p className="mt-2 text-[14.5px]">{done ? "Awarded: CertifyIQ Launch Certified." : current.lead}</p>
          ...
          {done && (
            <Panel bodyClassName="p-7">
              <div className="rounded-lg border-2 border-primary/40 p-6 text-center">
                ...
                <p className="cite mt-3 text-[10.5px] uppercase tracking-[0.24em]">CertifyIQ LaunchPad</p>

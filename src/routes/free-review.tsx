...
export const Route = createFileRoute("/free-review")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://certivoiq.com/free-review" },
    ],
    links: [{ rel: "canonical", href: "https://certivoiq.com/free-review" }],
  }),
  component: FreeReviewEntryPage,
});

function FreeReviewEntryPage() {
  return (
    <PublicShell>

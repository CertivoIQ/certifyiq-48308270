...
function AuthPage() {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-background px-4 py-12"><div className="w-full max-w-md">
      <Link to="/welcome" className="flex items-center justify-center gap-2.5"><img src="/certivoiq-logo.png" alt="CertivoIQ" className="h-11 w-auto rounded-md bg-white px-2 py-1.5 object-contain" /></Link>

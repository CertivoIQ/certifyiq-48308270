      ...
      <Panel bodyClassName="p-8">
        {!sessionId && (
          <>
            ...
            <p className="mt-2 max-w-2xl text-[13.5px] leading-relaxed text-muted-foreground">
              We couldn't find a checkout to confirm. If you just paid, open your billing page to
        ...
        {sessionId && isLoading && (
          <p className="flex items-center gap-2 text-[13.5px] text-muted-foreground">
            <Loader2 className="size-4 animate-spin" /> Confirming your payment with the payment
            provider…
          </p>
        )}
        ...
        {sessionId && failed && (
          <>
            ...
            <p className="mt-2 max-w-2xl text-[13.5px] leading-relaxed text-muted-foreground">
              {(data as { error: string }).error} Your card has not been charged twice — check your
              billing page before retrying.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              <Button asChild>
                <Link to="/billing">
        ...
        {sessionId && pending && (
          <>
            ...
            <p className="mt-2 max-w-2xl text-[13.5px] leading-relaxed text-muted-foreground">
              Some payment methods take a little longer to clear. We'll unlock your plan capacity
              automatically the moment it settles — no need to pay again.
            </p>
          </>
        )}
        ...
        {sessionId && paid && (
          <>
            ...
            <p className="mt-2 max-w-2xl text-[13.5px] leading-relaxed text-muted-foreground">
              Your plan capacity is unlocked, every certification you uploaded during the trial has
              been kept (the 14-day deletion hold is cleared), and your guided onboarding has
              started.

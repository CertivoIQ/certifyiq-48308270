...
export function FreeReviewEntryGate({ children }: { children: ReactNode }) {
  ...
  return (
    <Panel title="Start with your company details" description="Create your CertivoIQ account, tell us about your portfolio, and we'll prepare your 3 FREE certification reviews. Your certification upload comes immediately after this step." bodyClassName="p-5">
      <div className="mb-5 flex items-start gap-3 rounded-lg border border-primary/20 bg-primary/5 p-4"><ShieldCheck className="mt-0.5 size-5 shrink-0 text-primary" /><div><p className="font-medium">Required before any FREE certification upload</p><p className="mt-1 text-sm text-muted-foreground">These details create your warm CRM lead, determine the best-fit plan, and provide the recipient fields needed for future email outreach.</p></div></div>

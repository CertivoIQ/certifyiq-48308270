...
const tone: Record<Availability, string> = {
  yes: "bg-[#012459]/[0.06] text-[#012459] ring-[#012459]/25",
  partial: "bg-[#FEAD05]/15 text-[#5c4300] ring-[#FEAD05]/60",
    ...
    <section className="bg-white px-5 py-16 text-slate-950 sm:px-8" aria-labelledby="comparison-title">
      <div className="mx-auto max-w-7xl">
        <div className="max-w-3xl">
          <div className="flex items-center gap-2 text-[#012459]"><ShieldCheck className="h-5 w-5" /><span className="text-sm font-semibold uppercase tracking-[0.16em]">Platform comparison</span></div>
        ...
        <div className="mt-3 flex flex-wrap gap-x-5 gap-y-2 text-xs font-medium">
          <a className="text-[#012459] underline underline-offset-4" href="https://www.myresman.com/solutions/affordable-compliance/" target="_blank" rel="noreferrer">ResMan affordable compliance source</a>
          <a className="text-[#012459] underline underline-offset-4" href="https://www.appfolio.com/markets/affordable-housing" target="_blank" rel="noreferrer">AppFolio affordable housing source</a>
        </div>
      </div>
    </section>
  );

  ...
  return (
    ...
    >
      ...
      <div className="mt-4 grid gap-4 xl:grid-cols-[1.4fr_1fr]">
        ...
        <Panel title="HOTMA implementation" description="Applicability is derived from agency programs; HOTMA is not a selectable program.">
          <div className="space-y-3 text-sm">
            ...
            <div className="rounded-md border border-border bg-muted/30 p-3 text-[12.5px] text-muted-foreground">
              January 1, 2027 is treated as the full-compliance target in the readiness workflow. Policy, software, and transaction readiness should be completed before effective transactions reach that date.
            </div>
          </div>
        </Panel>
      </div>

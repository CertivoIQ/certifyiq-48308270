...
import { NspireActivationAlert } from "@/components/nspire-activation-alert";
...
const PHA_NAV = [
  ...
  { to: "/pha-nspire-standards", label: "NSPIRE Standards Control", icon: ShieldCheck, key: "compliance" },

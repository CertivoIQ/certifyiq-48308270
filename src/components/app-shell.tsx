...
const MF_OPERATIONS: readonly NavItem[] = [
  ...
  { to: "/compliance-intelligence", label: "Compliance Control Center", icon: LayoutDashboard },
...
const PHA_COMPLIANCE: readonly PhaNavItem[] = [
  ...
  { to: "/compliance-intelligence", label: "Compliance Control Center", icon: LayoutDashboard, key: "reports" },
];

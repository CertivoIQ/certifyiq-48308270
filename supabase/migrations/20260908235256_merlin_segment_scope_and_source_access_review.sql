...
BEGIN
 ...
 ELSIF _reason IN ('PDF_PAGE_LIMIT','PDF_TEXT_LIMIT','PROCEDURE_REVIEW_LIMIT','SOURCE_HTTP_403','SOURCE_HTTP_401','SOURCE_HTTP_404','NO_EXPLICIT_PROCEDURES','PDF_REQUIRES_SEGMENTATION','PDF_REQUIRES_OCR','SOURCE_TOO_LARGE','SOURCE_NOT_PDF','SOURCE_SHA256_MISMATCH','SOURCE_NOT_ELIGIBLE','SOURCE_URL_NOT_ALLOWED','SOURCE_HOST_NOT_ALLOWED') THEN

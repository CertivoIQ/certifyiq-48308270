...
BEGIN
 ...
 ELSIF _reason IN ('PDF_REQUIRES_SEGMENTATION','PDF_REQUIRES_OCR','SOURCE_TOO_LARGE','SOURCE_NOT_PDF','SOURCE_SHA256_MISMATCH','SOURCE_NOT_ELIGIBLE','SOURCE_URL_NOT_ALLOWED','SOURCE_HOST_NOT_ALLOWED') THEN

-- Aggregate operational observation only. No job execution or customer communications.
...
END;
$$;
REVOKE ALL ON FUNCTION private.certivoiq_absence_watchdog() FROM PUBLIC, anon, authenticated, service_role;
COMMENT ON FUNCTION private.certivoiq_absence_watchdog() IS
'Internal postgres cron observation. Aggregates operational exceptions into existing staff incident queue; never executes jobs or sends communications.';

...
revoke all on function public.crm_prepare_verified_sale() from public, anon, authenticated;
revoke all on function public.crm_sync_post_sale_checklist() from public, anon, authenticated;
